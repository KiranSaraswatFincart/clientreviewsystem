...
public static ExtentReports getExtentReport()
{
	...
	File extentReportFile=new File("C:\\Users\\FINCART\\eclipse-workspace\\clientreview\\test-output\\ExtentReportsFolder\\extentreport.html");
	ExtentSparkReporter sparkReporter=new 	ExtentSparkReporter(extentReportFile);
	sparkReporter.config().setTheme(Theme.DARK);
	sparkReporter.config().setDocumentTitle("Clientreview automation test result");
	sparkReporter.config().setReportName("Client review report");
